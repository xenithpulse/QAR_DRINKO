...
// import "./footer.css";
// import useProdcts from "../../../context/productsContext.js";
// import { Link } from "react-router-dom";
// function Footer() {
//   const { products } = useProdcts();
//   return (
//     <>
//       <div className="footer">
//         <div className="products-name-container spacey">
//           <h1 className="products-heading-footer text-2xl font-bold text-center">
//             Products
//           </h1>
//           {products && (
//             <div className="products-name flex flex-col  space-y-5 text-center  ">
//               {products.map((p) => {
//                 return <Link to={`/product/${p._id}`}>{p.title} </Link>;
//               })}
//             </div>
//           )}
//         </div>

//         <div className="about-us-footer"></div>
//       </div>
//     </>
//   );
// }
...
function Footer() {
  return (
    <div className="footer h-fit  text-center pt-10  pb-3 text-[12px] space-y-6 sm:text-[14px]">
